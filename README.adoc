This is a fork of the original project as it is not currently maintained. See: https://github.com/kameshsampath/antora-site-action/pull/9#issuecomment-1019040572
